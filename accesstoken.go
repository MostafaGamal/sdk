...
func (s *AccessToken) GetAccessToken(ctx context.Context, request *operations.GetAccessTokenRequestBody, opts ...operations.Option) (*operations.GetAccessTokenResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.GetAccessTokenServerList[0], map[string]string{})
	if o.ServerURL != nil {
		baseURL = *o.ServerURL
	}

	opURL, err := url.JoinPath(baseURL, "/realms/pfm/protocol/openid-connect/token")
	if err != nil {
