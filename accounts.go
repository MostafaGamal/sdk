...
func (s *Accounts) GetUserAccounts(ctx context.Context, connectionID int64, opts ...operations.Option) (*operations.GetUserAccountsResponse, error) {
	...
	request := operations.GetUserAccountsRequest{
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/ais/users/connections/{connection_id}/accounts", request, nil)
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.AccountsResponse
...
func (s *Accounts) GetUserAccountByID(ctx context.Context, accountID int64, connectionID int64, opts ...operations.Option) (*operations.GetUserAccountByIDResponse, error) {
	...
	request := operations.GetUserAccountByIDRequest{
		AccountID:    accountID,
		ConnectionID: connectionID,
	}
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/ais/users/connections/{connection_id}/accounts/{account_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetUserAccountByIDResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *Accounts) GetUserAccountBalances(ctx context.Context, request operations.GetUserAccountBalancesRequest, opts ...operations.Option) (*operations.GetUserAccountBalancesResponse, error) {
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/ais/users/connections/{connection_id}/accounts/{account_id}/balances", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetUserAccountBalancesResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.AccountBalancesResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.AccountBalancesResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
