...
var ServerList = []string{
	...
	"https://pfm.thefinx.io/api/v1",
	// The development API server
	"https://pfm.thefinxdev.io/api/v1",
}
...
func WithSecurity(openID string) SDKOption {
	return func(sdk *Pfm) {
		security := components.Security{OpenID: &openID}
...
func New(opts ...SDKOption) *Pfm {
	...
	sdk.Kyc = newKyc(sdk.sdkConfiguration)
	...
	sdk.Helpdesk = newHelpdesk(sdk.sdkConfiguration)
